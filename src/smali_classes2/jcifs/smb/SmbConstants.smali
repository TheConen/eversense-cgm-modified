...
.method static constructor <clinit>()V
    ...
    const-string v1, "jcifs.smb.client.lport"
    ...
    sput v1, Ljcifs/smb/SmbConstants;->LPORT:I

    const-string v1, "jcifs.smb.client.maxMpxCount"
    ...
    sput v1, Ljcifs/smb/SmbConstants;->MAX_MPX_COUNT:I

    const-string v1, "jcifs.smb.client.snd_buf_size"
    ...
    sput v1, Ljcifs/smb/SmbConstants;->SND_BUF_SIZE:I

    const-string v1, "jcifs.smb.client.rcv_buf_size"
    ...
    sput v1, Ljcifs/smb/SmbConstants;->RCV_BUF_SIZE:I
    ...
    sput-boolean v1, Ljcifs/smb/SmbConstants;->FORCE_UNICODE:Z
    ...
    sput-boolean v1, Ljcifs/smb/SmbConstants;->USE_NTSTATUS:Z

    const-string v1, "jcifs.smb.client.signingPreferred"
    ...
    sput-boolean v1, Ljcifs/smb/SmbConstants;->SIGNPREF:Z

    const-string v1, "jcifs.smb.client.useNTSmbs"
    ...
    sput-boolean v1, Ljcifs/smb/SmbConstants;->USE_NTSMBS:Z

    const-string v1, "jcifs.smb.client.useExtendedSecurity"
    ...
    sput-boolean v1, Ljcifs/smb/SmbConstants;->USE_EXTSEC:Z

    const/4 v1, 0x0

    const-string v3, "jcifs.netbios.hostname"

    .line 32
    invoke-static {v3, v1}, Ljcifs/Config;->getProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    sput-object v3, Ljcifs/smb/SmbConstants;->NETBIOS_HOSTNAME:Ljava/lang/String;

    const/4 v3, 0x3

    const-string v4, "jcifs.smb.lmCompatibility"

    .line 33
    invoke-static {v4, v3}, Ljcifs/Config;->getInt(Ljava/lang/String;I)I

    move-result v4

    sput v4, Ljcifs/smb/SmbConstants;->LM_COMPATIBILITY:I
    ...
    sput v4, Ljcifs/smb/SmbConstants;->PID:I
    ...
    sput-object v4, Ljcifs/smb/SmbConstants;->TZ:Ljava/util/TimeZone;

    const-string v4, "jcifs.smb.client.useBatching"

    .line 129
    invoke-static {v4, v2}, Ljcifs/Config;->getBoolean(Ljava/lang/String;Z)Z
    ...
    const-string v4, "jcifs.encoding"

    invoke-static {v4, v2}, Ljcifs/Config;->getProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 132
    sget-boolean v2, Ljcifs/smb/SmbConstants;->USE_EXTSEC:Z
    ...
    sget-boolean v3, Ljcifs/smb/SmbConstants;->SIGNPREF:Z
    ...
    .line 139
    sget-boolean v2, Ljcifs/smb/SmbConstants;->USE_NTSMBS:Z
    ...
    sput v2, Ljcifs/smb/SmbConstants;->DEFAULT_CAPABILITIES:I
    ...
    const-string v3, "jcifs.smb.client.capabilities"

    invoke-static {v3, v2}, Ljcifs/Config;->getInt(Ljava/lang/String;I)I

    move-result v2

    sput v2, Ljcifs/smb/SmbConstants;->CAPABILITIES:I

    const-string v2, "jcifs.smb.client.tcpNoDelay"
    ...
    sput-boolean v2, Ljcifs/smb/SmbConstants;->TCP_NODELAY:Z

    const/16 v2, 0x7530

    const-string v3, "jcifs.smb.client.responseTimeout"
    ...
    sput v2, Ljcifs/smb/SmbConstants;->RESPONSE_TIMEOUT:I
    ...
    sput-object v2, Ljcifs/smb/SmbConstants;->CONNECTIONS:Ljava/util/LinkedList;

    const/16 v2, 0xfa

    const-string v3, "jcifs.smb.client.ssnLimit"
    ...
    sput v2, Ljcifs/smb/SmbConstants;->SSN_LIMIT:I
    ...
    sput v3, Ljcifs/smb/SmbConstants;->SO_TIMEOUT:I

    const-string v3, "jcifs.smb.client.connTimeout"
    ...
    sput v2, Ljcifs/smb/SmbConstants;->CONN_TIMEOUT:I
    ...
    const-string v3, "jcifs.smb.client.nativeOs"

    invoke-static {v3, v2}, Ljcifs/Config;->getProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    sput-object v2, Ljcifs/smb/SmbConstants;->NATIVE_OS:Ljava/lang/String;

    const-string v2, "jcifs.smb.client.nativeLanMan"

    const-string v3, "jCIFS"

    .line 160
    invoke-static {v2, v3}, Ljcifs/Config;->getProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    sput-object v2, Ljcifs/smb/SmbConstants;->NATIVE_LANMAN:Ljava/lang/String;

    .line 163
    new-instance v2, Ljcifs/smb/SmbTransport;

    invoke-direct {v2, v1, v0, v1, v0}, Ljcifs/smb/SmbTransport;-><init>(Ljcifs/UniAddress;ILjava/net/InetAddress;I)V

    sput-object v2, Ljcifs/smb/SmbConstants;->NULL_TRANSPORT:Ljcifs/smb/SmbTransport;
