...
.method private changeGroupId(II)V
    ...
    invoke-virtual {p1, v2, v0, v1, p2}, Landroid/database/sqlite/SQLiteDatabase;->update(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
...
.method private hideCalibrationEventAndGetNotesDuringSyncSubMethod(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v5, v7, p2, v6, v1}, Landroid/database/sqlite/SQLiteDatabase;->update(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    const-string v1, "BGM-> no of events updated : "
...
.method private updateCalibrationAndGlucoseEventRecordNo(Lcom/senseonics/events/EventPoint;)I
    ...
    invoke-virtual {v7, v9, v5, v8, v6}, Landroid/database/sqlite/SQLiteDatabase;->update(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
...
.method public addReadingInGMT(Lcom/senseonics/graph/util/Glucose;)V
    ...
    const-string v3, "addReadingInGMT "
...
.method public convertSuspiciousGlucoseIntoCalibrationDuringSync(Lcom/senseonics/events/GlucoseEventPoint;)I
    ...
    invoke-virtual {v3, v7, v4, v6, v5}, Landroid/database/sqlite/SQLiteDatabase;->update(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
...
.method public getNotificationsBetween(Landroid/content/Context;Ljava/util/Calendar;Ljava/util/Calendar;Ljava/util/List;IZZLjava/lang/String;ZZZZZLcom/senseonics/util/AlertHelper;)Ljava/util/ArrayList;
    ...
    check-cast v7, Lcom/senseonics/util/Utils$EVENT_TYPE;
    ...
    .line 1769
    iget-object v12, v2, Lcom/senseonics/db/DatabaseManager;->database:Landroid/database/sqlite/SQLiteDatabase;

    const-string v20, "timestamp"

    const-string v21, "eventType"

    const-string v22, "notes"

    const-string v23, "amount"

    const-string v24, "customType"

    const-string v25, "customType2"

    const-string v26, "healthSeverity"

    const-string v27, "exerciseIntensity"

    const-string v28, "glucoseLevel"

    const-string v29, "id"

    const-string v30, "event_synced"

    const-string v31, "event_hidden"

    const-string v32, "event_hidden_timestamp"

    const-string v33, "transmitter_name"

    const-string v34, "unknown_error_code"

    const-string v35, "recordNumber"
    ...
    .line 1887
    invoke-virtual {v14, v0}, Lcom/senseonics/events/ExerciseEventPoint;->getDurationText(Landroid/content/Context;)Ljava/lang/String;
...
.method public getSensorLogsStartingFrom(Ljava/util/Calendar;Ljava/util/Calendar;)Ljava/util/ArrayList;
    ...
    .line 740
    new-instance v3, Lcom/senseonics/graph/util/Glucose;
    ...
    invoke-direct/range {v8 .. v14}, Lcom/senseonics/graph/util/Glucose;-><init>(JIII[I)V
