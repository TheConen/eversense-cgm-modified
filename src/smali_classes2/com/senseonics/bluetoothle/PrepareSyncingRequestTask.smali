...
.method private createSyncingGroups(IILcom/senseonics/bluetoothle/PrepareSyncingRequestTask$SYNC_DATA_TYPE;)Ljava/util/List;
    ...
    .line 203
    :cond_1
    sget-object v6, Lcom/senseonics/bluetoothle/PrepareSyncingRequestTask$SYNC_DATA_TYPE;->READ_SENSOR_GLUCOSE:Lcom/senseonics/bluetoothle/PrepareSyncingRequestTask$SYNC_DATA_TYPE;
    ...
    .line 205
    invoke-static {v5}, Lcom/senseonics/bluetoothle/BinaryOperations;->data24BitsFromIntLSByteFirst(I)[I
    ...
    .line 212
    sget-object v9, Lcom/senseonics/bluetoothle/PrepareSyncingRequestTask$1;->$SwitchMap$com$senseonics$bluetoothle$PrepareSyncingRequestTask$SYNC_DATA_TYPE:[I
    ...
    const-string v11, "BGM - Send range: "
    ...
    .line 227
    invoke-static {v6, v7, v5, p1}, Lcom/senseonics/bluetoothle/PrepareSyncingRequestTask;->getRequestReadBloodGlucoseDataInSpecifiedRange([I[III)Lcom/senseonics/bluetoothle/TransmitterSyncRequest;
    ...
    const-string v11, "Alert - Send range: "
    ...
    .line 221
    invoke-static {v6, v7, v5, p1}, Lcom/senseonics/bluetoothle/PrepareSyncingRequestTask;->getRequestReadSensorGlucoseAlertInSpecifiedRange([I[III)Lcom/senseonics/bluetoothle/TransmitterSyncRequest;
    ...
    const-string v11, "Glucose - Send range: "
    ...
    .line 215
    invoke-static {v6, v7, v5, p1}, Lcom/senseonics/bluetoothle/PrepareSyncingRequestTask;->getRequestReadAllSensorGlucoseDataInSpecifiedRange([I[III)Lcom/senseonics/bluetoothle/TransmitterSyncRequest;
    ...
    .line 232
    invoke-virtual {v8}, Lcom/senseonics/bluetoothle/TransmitterSyncRequest;->getData()[I
    ...
    const-string v6, "adding request: "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v8}, Lcom/senseonics/bluetoothle/TransmitterSyncRequest;->toString()Ljava/lang/String;
...
.method protected varargs doInBackground([Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-virtual {v1}, Lcom/senseonics/model/TransmitterStateModel;->getSensorGlucoseRecordRange()Lcom/senseonics/util/Range;
    ...
    invoke-direct {v5, v4, v1}, Lcom/senseonics/util/Range;-><init>(II)V
    ...
    invoke-direct {v4, v5, v1}, Lcom/senseonics/util/Range;-><init>(II)V
    ...
    const-string v6, "**** SENSOR whole range:"
    ...
    invoke-direct {p0, v1, v4}, Lcom/senseonics/bluetoothle/PrepareSyncingRequestTask;->createSyncingGroupsFrom(Lcom/senseonics/util/Range;Lcom/senseonics/bluetoothle/PrepareSyncingRequestTask$SYNC_DATA_TYPE;)Ljava/util/List;
    ...
    invoke-virtual {v1}, Lcom/senseonics/model/TransmitterStateModel;->getAlertRecordRange()Lcom/senseonics/util/Range;
    ...
    const-string v6, "**** ALERT whole range:"
    ...
    invoke-virtual {v1}, Lcom/senseonics/model/TransmitterStateModel;->getBloodGlucoseRecordRange()Lcom/senseonics/util/Range;
    ...
    const-string v6, "**** BGM whole range:"
    ...
    invoke-direct {p0, v1, v2}, Lcom/senseonics/bluetoothle/PrepareSyncingRequestTask;->createSyncingGroupsFrom(Lcom/senseonics/util/Range;Lcom/senseonics/bluetoothle/PrepareSyncingRequestTask$SYNC_DATA_TYPE;)Ljava/util/List;
    ...
    .line 127
    :cond_11
    iget-object v1, p0, Lcom/senseonics/bluetoothle/PrepareSyncingRequestTask;->databaseManager:Lcom/senseonics/db/DatabaseManager;
    ...
    invoke-virtual {v1, v2, v4, v5, v6}, Lcom/senseonics/db/DatabaseManager;->getNotSyncedEventsBetween(Ljava/util/Calendar;Ljava/util/Calendar;II)Ljava/util/ArrayList;
